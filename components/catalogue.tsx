    ...
    >
      <div className="mx-auto w-full max-w-6xl px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="mt-14 flex flex-col gap-4">
          ...
          {/* Container dikunci pada tinggi 152px agar pas dengan widget Spotify Compact */}
          <div className="h-[152px] w-full overflow-hidden rounded-xl border border-border bg-[#121212]">
            <iframe
              title={`${artist.playlist.name} on Spotify`}
              /* Mengapus &theme=0 dan menyisakan parameter default agar tetap dark theme bawaan Spotify */
