...
export const artist = {
  ...
  bio: [
    ...
    'Released across Stellar Waves Records, Row Records, Cafe De Anatolia and Proton, with a catalogue spanning originals and official remixes of Avicii, Anyma, John Summit, Argy and Korolova. Charted at #1 on the Indonesia Dance Chart with "Loves Fall".',
  ],
  socials: {
